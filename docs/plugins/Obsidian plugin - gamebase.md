---
uid: 87819e6d-c1b2-5b51-8258-618226ff5c55
xid:
  - gamebase
aliases:
  - gamebase
...
Searches video games through the IGDB API and generates notes from custom markdown templates, so release dates, developers and genres do not have to be typed by hand. A game is looked up from the command palette or a ribbon icon, and a bulk import staging interface queues several games and imports them in one click. The recorded About text is promotional and its claims are not repeated here.

```cue
plugin: {
    id:     "gamebase"
    name:   "Gamebase"
    author: "AndyPandy1189"
    repo:   "andypandy1189/obsidian-game-search"

    html_url:    "https://community.obsidian.md/plugins/gamebase"
    github_url:  "https://github.com/andypandy1189/obsidian-game-search"
    description: "Effortlessly search and pull rich video game metadata to automatically generate beautifully formatted notes in your vault using your own custom markdown templates - This plugin has not been manually reviewed by Obsidian staff."
